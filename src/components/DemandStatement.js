    ...
    return (
      <div className='Postform'>
        {result.map((res) =>
          ...
          <div className="Postform">
            <h6 className="Postform">You are requested to remit the total dues of <b>₹ {props.value3}/-</b> in favour of <b>"AIGIN BUILDCON PVT LTD"</b> payable at on or before {res.due_date}</h6>
